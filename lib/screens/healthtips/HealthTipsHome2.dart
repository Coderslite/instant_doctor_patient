...
// class HealthTipsHome2 extends StatefulWidget {
//   final String tipsType;
//   final String image;
//   const HealthTipsHome2(
//       {super.key, required this.tipsType, required this.image});

//   @override
//   State<HealthTipsHome2> createState() => _HealthTipsHomeState();
// }

// class _HealthTipsHomeState extends State<HealthTipsHome2> {
//   @override
...
//                 )
//                     .paddingLeft(10)
//                     .visible(settingsController.panelController.isPanelOpen),
//                 10.height,
//                 Expanded(
